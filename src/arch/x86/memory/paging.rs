...
pub(crate) extern "x86-interrupt" fn page_fault_handler(stack_frame: ExceptionStackFrame, error_code: u64) {
...
#[allow(dead_code)]
pub(crate) fn get_page_table_entry<S: PageSize>(virtual_address: VirtAddr) -> Option<PageTableEntry> {
...
pub(crate) fn map<S: PageSize>(virtual_address: VirtAddr, physical_address: PhysAddr, count: usize, flags: PageTableEntryFlags) {
